...
System.exit(2);
 ...
 /* There is still room in the queue, so store the time of arrival of the arriving
customer at the (new) end of time_arrival. */
...
sim_time));
buffer.append(String.format(OUTFILE + " Time simulation ended%12.3f minutes",
sim_time));
 }
